import { BrutalistHeroPlayer } from "@/components/templates/brutalist/HeroPlayer";
...
export const metadata = { title: "Brutalist — Ibrahim Tariq" };
...
export default function BrutalistTemplate() {
  return (
    <div className="min-h-screen bg-white pt-[72px] font-[family-name:var(--font-space-grotesk)] text-[#ff0000]">
      <ScrollTickerPlayer />
      <BackToTemplates variant="light" offset="belowTicker" />
        ...
        <div className="mx-auto max-w-[1400px] px-6 py-20">
          ...
          <div className="grid gap-0 border-[3px] border-[#ff0000]">
            {projects.map((p, i) => (
              <article
                key={p.name}
                className={`grid gap-6 border-[#ff0000] p-8 md:grid-cols-12 ${
