...
export default function HeroSection() {
  ...
  return (
    <motion.section
      ref={containerRef}
      id="home"
      className="relative min-h-[100vh] flex flex-col items-center overflow-hidden px-4 sm:px-6 pt-0 sm:pt-24 pb-16"
      initial="hidden"
      animate="visible"
    ...
    >
      ...
      <motion.div
        ...
        className="relative z-10 text-center w-full max-w-4xl mx-auto space-y-2 sm:space-y-8 mt-0 sm:mt-8 flex flex-col justify-center min-h-screen sm:min-h-0 sm:justify-start"
      >
        <div className="flex flex-col justify-center min-h-screen sm:min-h-0 sm:justify-start -mt-32 sm:mt-0">
        <motion.div
          variants={profileAnimation}
          initial={{ scale: 0, opacity: 0 }}
          animate={profileControls}
          className="mx-auto mb-4 sm:mb-10 mt-0 sm:mt-12"
          style={{ willChange: "transform, opacity" }}
        >
          <ProfileCard />
        </motion.div>
